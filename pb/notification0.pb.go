...
var file_notification0_proto_rawDesc = []byte{
	...
	0x4c, 0x55, 0x52, 0x45, 0x10, 0x02, 0x32, 0x7b, 0x0a, 0x0c, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69,
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x6b, 0x0a, 0x0c, 0x73, 0x68, 0x6f, 0x75, 0x6c, 0x64,
	0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x2b, 0x2e, 0x73, 0x63, 0x6f, 0x72, 0x69, 0x6e, 0x67,
	...
	0x65, 0x73, 0x74, 0x1a, 0x2c, 0x2e, 0x73, 0x63, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x73, 0x65, 0x72,
	...
	0x65, 0x22, 0x00, 0x32, 0x4d, 0x0a, 0x06, 0x4c, 0x6f, 0x67, 0x67, 0x65, 0x72, 0x12, 0x43, 0x0a,
	0x08, 0x4c, 0x6f, 0x67, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x1a, 0x2e, 0x73, 0x63, 0x6f, 0x72,
	0x69, 0x6e, 0x67, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x73, 0x63, 0x6f, 0x72, 0x69, 0x6e, 0x67, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x3b, 0x70, 0x62,
}
...
var file_notification0_proto_depIdxs = []int32{
	...
	2,  // 10: scoringservice.Notification.shouldNotify:input_type -> scoringservice.ExposureNotificationRequest
	6,  // 11: scoringservice.Logger.LogEvent:input_type -> scoringservice.LogRequest
	3,  // 12: scoringservice.Notification.shouldNotify:output_type -> scoringservice.ExposureNotificationResponse
...
func (c *notificationClient) ShouldNotify(ctx context.Context, in *ExposureNotificationRequest, opts ...grpc.CallOption) (*ExposureNotificationResponse, error) {
	out := new(ExposureNotificationResponse)
	err := c.cc.Invoke(ctx, "/scoringservice.Notification/shouldNotify", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedNotificationServer) ShouldNotify(context.Context, *ExposureNotificationRequest) (*ExposureNotificationResponse, error) {
...
func _Notification_ShouldNotify_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExposureNotificationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotificationServer).ShouldNotify(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/scoringservice.Notification/ShouldNotify",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServer).ShouldNotify(ctx, req.(*ExposureNotificationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Notification_serviceDesc = grpc.ServiceDesc{
	ServiceName: "scoringservice.Notification",
	HandlerType: (*NotificationServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "shouldNotify",
			Handler:    _Notification_ShouldNotify_Handler,
		},
	},
